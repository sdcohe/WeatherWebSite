			...
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<div class="post-bgtop">
							<div class="post-bgbtm">
								<h2 class="title">Local Radar</h2>
								<p class="meta">From the NWS</p>
								<div class="entry">
									<img src="http://radar.weather.gov/ridge/lite/N0R/LWX_loop.gif" alt="Local Radar" />
								</div>
							</div>
						</div>
					</div>
                    ...
                    <div class="post">
						<div class="post-bgtop">
							<div class="post-bgbtm">
								<h2 class="title">Regional Radar</h2>
								<p class="meta">From Weather Underground</p>
								<div class="entry">
									<img src="https://s.w-x.co/staticmaps/wu/wu/wxtype1200_cur/usshd/animate.png" width="640" height="480" alt="Regional radar" />
								</div>
							</div>
						</div>
					</div> 
